...
main() {
    ...
    # # Sanitize index name
    # HISAT2_INDEX="$(dirname "$REFERENCE_GENOME")/$(basename "${REFERENCE_GENOME%.fa}" | tr ' ' '_')"
    ...
    # echo "\n BEGIN DIRECTORY CHECK"
    # # Create all directories with explicit checks
    # # Replace brace expansion with explicit paths
    # dirs=(
    #     "${WORKING_DIRECTORY}/data/fastqc1"
    #     "${WORKING_DIRECTORY}/data/trimmed_reads" 
    #     "${WORKING_DIRECTORY}/data/alignments"
    #     "${WORKING_DIRECTORY}/data/quant"
    #     "${WORKING_DIRECTORY}/data/multiqc1"
    #     "${WORKING_DIRECTORY}/data/multiqc2"
